"""
Report helper functions for test example.

Модуль содержит функции для формирования отчетов и светофоров.
Является копией llm_val/report_helper.py с небольшими отличиями
в цветовой схеме ('amber' вместо 'yellow').
"""
...
def semaphore_by_threshold(
    ...
    Returns:
        Цвет светофора: 'red', 'amber' или 'green'
    """
...
def semaphore_by_threshold_without_red(
    ...
    Returns:
        Цвет светофора: 'amber' или 'green'
    """
...
def tricky_semaphore(
    ...
    Args:
        ...
        semaphore_list: Список светофоров
